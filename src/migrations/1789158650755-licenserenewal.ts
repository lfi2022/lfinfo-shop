...
export class Licenserenewal1789158650755 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`ALTER TABLE "order_license" DROP COLUMN IF EXISTS "renewalReminder15SentAt"`, undefined);
        await queryRunner.query(`ALTER TABLE "order_license" DROP COLUMN IF EXISTS "renewalReminder7SentAt"`, undefined);
        await queryRunner.query(`ALTER TABLE "order_license" DROP COLUMN IF EXISTS "renewalReminder1SentAt"`, undefined);
