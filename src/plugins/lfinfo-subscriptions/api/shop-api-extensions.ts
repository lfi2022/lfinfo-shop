...
export const shopApiExtensions = gql`
  ...
  type MySubscription implements Node { id: ID! createdAt: DateTime! updatedAt: DateTime! planId: ID! productVariantId: ID! status: SubscriptionStatus! startedAt: DateTime! expiresAt: DateTime! cancelledAt: DateTime recurringConsentAt: DateTime recurringConsentVersion: String planName: String! productName: String! }
